...
# TODO: should we separate the Model from the CausalLM class?
...
class MultiModalModel(PreTrainedModel):
    ...
    # PreTrainedModel ensures this is called only once
    def _init_weights(self, module):
        pass

    def get_vision_tower(self):
        # TODO: check if vision encoder is loaded (first setup lazy load of vision encoder)
        return self.vision_encoder

    # TODO: create methods to freeze backbones
    ...
    # TODO: remove this method all together. do all initialization in from_pretrained, __init__, _init_weights, or post_init()
